...
import { PlayCircleOutlined, FileTextOutlined, SyncOutlined } from '@ant-design/icons'
...
export default function GeneratePage() {
  ...
  const handleIngest = async () => {
    Modal.confirm({
      title: '确认生成',
      content: `确定要生成 ${limit} 篇论文的Wiki内容吗？这可能需要一些时间。`,
      onOk: async () => {
        setIngesting(true)
  ...
  return (
    <div className="py-6 animate-fade-in">
      <Title level={2} style={{ color: 'var(--text-primary)', marginBottom: 24 }}>
        <PlayCircleOutlined className="mr-2" style={{ color: 'var(--accent)' }} />
        论文生成
      </Title>
