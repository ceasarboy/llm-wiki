...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v2.3 | 2026-05-10 | 全局异常日志、FAQ 自动生成、知识库分页、问答保存、引用追溯、PDF 转换方案总结 |
| v2.0 | 2026-05-09 | 冲突检测 + 引用追溯 + V2 开发计划完成 |
| v1.1 | 2026-05-05 | 路由拆分（13 模块）、call_llm 重试机制、BGE-M3 混合搜索 |
| v1.0 | 2026-05-01 | 初始版本：PDF 管道 + Wiki 页面 + 前端 CRUD |
